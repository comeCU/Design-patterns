...
public class XMLUtil {
	...
	public static Object getBean() {
		...
		try {
			...
			Document doc;
			doc = builder.parse(new File("src\\com\\dong\\patterns\\abstractfactory\\config.xml"));
			...
			String cName = "com.dong.patterns.abstractfactory." + classNode.getNodeValue().trim();   // 拼接类路径
