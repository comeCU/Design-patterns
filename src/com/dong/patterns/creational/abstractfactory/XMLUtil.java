...
public class XMLUtil {
	...
	public static Object getBean() {
		...
		try {
			...
			Document doc;
			doc = builder.parse(new File("src\\com\\dong\\patterns\\creational\\abstractfactory\\config.xml"));
			...
			String cName = "com.dong.patterns.creational.abstractfactory." + classNode.getNodeValue().trim();   // 拼接类路径
